...
namespace ZBlog.Migrations
{
    ...
    [Migration("20201025052910_websiteRequest")]
    partial class websiteRequest
    {
            ...
            modelBuilder.Entity("ZBlog.Data.Entity.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreateTime = new DateTime(2020, 10, 25, 13, 29, 9, 684, DateTimeKind.Local).AddTicks(5790),
                            Password = "zhao",
                            UpdateTime = new DateTime(2020, 10, 25, 13, 29, 9, 694, DateTimeKind.Local).AddTicks(1190),
                            UserName = "tian"
                        });
                });
