...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("erlang",function(){"use strict";return function(e){
...
},contains:[E]},c,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
...
contains:b}}}());hljs.registerLanguage("pgsql",function(){"use strict";return function(E){
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}}());hljs.registerLanguage("haml",function(){"use strict";return function(e){return{
name:"HAML",case_insensitive:!0,contains:[{className:"meta",
...
subLanguage:"ruby"}}]}}}());hljs.registerLanguage("c-like",function(){"use strict";return function(e){
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}}());hljs.registerLanguage("haskell",function(){"use strict";return function(e){
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}}());hljs.registerLanguage("xml",function(){"use strict";return function(e){var n={
...
}());hljs.registerLanguage("asciidoc",function(){"use strict";return function(e){
return{name:"AsciiDoc",aliases:["adoc"],
...
className:"symbol",begin:"^(NOTE|TIP|IMPORTANT|WARNING|CAUTION):\\s+",
relevance:10},{className:"strong",begin:"\\B\\*(?![\\*\\s])",end:"(\\n{2}|\\*)",
contains:[{begin:"\\\\*\\w",relevance:0}]},{className:"emphasis",
begin:"\\B'(?!['\\s])",end:"(\\n{2}|')",contains:[{begin:"\\\\'\\w",relevance:0
}],relevance:0},{className:"emphasis",begin:"_(?![_\\s])",end:"(\\n{2}|_)",
relevance:0},{className:"string",variants:[{begin:"``.+?''"},{begin:"`.+?'"}]},{
...
excludeBegin:!0,excludeEnd:!0,relevance:0}],relevance:10}]}}}());hljs.registerLanguage("basic",function(){"use strict";return function(E){return{
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]}}}());hljs.registerLanguage("diff",function(){"use strict";return function(e){return{
...
contains:[e.UNDERSCORE_TITLE_MODE]},{begin:"=>"},l,s]}}}());hljs.registerLanguage("elixir",function(){"use strict";return function(e){
...
name:"Elixir",keywords:i,contains:t}}}());hljs.registerLanguage("css",function(){"use strict";return function(e){var n={
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}}());hljs.registerLanguage("dart",function(){"use strict";return function(e){
...
className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}}());hljs.registerLanguage("sql",function(){"use strict";return function(e){
...
relevance:0}]}}}());hljs.registerLanguage("lasso",function(){"use strict";return function(e){
var a="<\\?(lasso(script)?|=)",n="\\]|\\?>",r={
...
begin:"^#!",end:"lasso9$",relevance:10}].concat(l)}}}());hljs.registerLanguage("matlab",function(){"use strict";return function(e){
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*\\%\\{\\s*$","^\\s*\\%\\}\\s*$"),e.COMMENT("\\%","$")]}}}());hljs.registerLanguage("ini",function(){"use strict";function e(e){
...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("django",function(){"use strict";return function(e){
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},c,i]}}}());hljs.registerLanguage("cmake",function(){"use strict";return function(e){return{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]}}}());hljs.registerLanguage("shell",function(){"use strict";return function(s){return{
